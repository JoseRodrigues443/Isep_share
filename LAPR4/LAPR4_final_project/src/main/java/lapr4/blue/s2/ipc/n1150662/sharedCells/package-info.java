/**
 * Technical documentation regarding the user story Ipc1.2: Sharing's Automatic Update
 * 
 * <h2>1. Notes</h2>
 * 
 * -Notes about the week's work.-
 * <p>
 * During the first day i did the Anylysis of the user story.
 *
 * <h2>2. Requirement</h2>
 * Setup extension for sharing cells.The user should be able to share cells with other user in the same network automatically.
 * 
 * <p>
 * <b>Use Case "Sharing's Automatic Update":</b> The user iniciates the share cell ui.The system asks to select the cell area(if the area is not already selected).The user selects the area of the cells.The system lists all the users in the same network.The user selects one of the machines.The system informs the succes of the operation.Done
 * 
 *  
 * <h2>3. Analysis</h2>
