...
import lapr4.blue.s1.core.n1150630.insertImage.InsertImageCellListener;
 ...
 * @author David
 */
public class ImagePanel extends javax.swing.JPanel implements SelectionListener, InsertImageCellListener {

    private InsertImageCell cell;

    private ShowImage controller;
     ...
     */
    public ImagePanel(UIController uiController) {
        initComponents();
        this.setLayout(new BorderLayout());
        controller = new ShowImage(uiController, this);
//        uiController.addSelectionListener(this);
    ...
    private void previousButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_previousButtonActionPerformed
        String img = controller.previousCellImage();
        setImageInLabel(img);
        disableNextButton();
    ...
    private void nextButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextButtonActionPerformed
        String img = controller.nexCellImage();
        setImageInLabel(img);
        disableNextButton();
        disablePreviousButton();
    ...
    public void selectionChanged(SelectionEvent event) {
        ...
        if (cell != null) {
            InsertImageCell activeCell = (InsertImageCell) cell.getExtension(ImageExtension.NAME);
            activeCell.addInsertImageCellListener(this);
            insertImageChanged(activeCell);
        }

        if (event.getPreviousCell() != null) {
            ((InsertImageCell) event.getPreviousCell().getExtension(ImageExtension.NAME)).removeInsertImageCellListener(this);
        }
    }
    ...
    public void setImage(String image) {
        if ("This cell has no image.".equals(image)) {
    ...
    /**
     *Method that disables the button remove if there is no image beeing displayed
     */
     ...
     * @param path image to be displayed
     */
    private void setImageInLabel(String path) {
