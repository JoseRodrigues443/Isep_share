 ...
 * @author bruno
 */
public class NavigationWindowValue extends JDialog {
     private final NavigationController controller;
    private final Dimension dimTree = new Dimension(300, 400);
    
    public NavigationWindowValue(UIController uiController,NavigationPanel panel) {
    ...
    private DefaultMutableTreeNode buildTree(){
		...
		Map<String,Value> data = controller.getValueFromCells();
