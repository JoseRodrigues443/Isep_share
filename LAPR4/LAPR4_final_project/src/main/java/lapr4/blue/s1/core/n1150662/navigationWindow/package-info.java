 ...
 * <p>
 * No notes regarding this week's work
 *
 * <h2>2. Requirement</h2>
 * Open a side bar that lets the user navigate through the workbook.
 * It lets the user search values and formulas if the cell contains comments.
 * 
 * <p>
 * <b>Use Case "Navigation Window":</b> Iniciates in the system the Navigation Panel.The system shows the navigation sidebar. The user chooses an option. The system shows all matches according to the option.Done
 * 
 *  
 * <h2>3. Analysis</h2>
 * Since the navigation window will be supported in a new extension to cleansheets we need to study how extensions are loaded by cleansheets and how they work.
 * 
 * 
