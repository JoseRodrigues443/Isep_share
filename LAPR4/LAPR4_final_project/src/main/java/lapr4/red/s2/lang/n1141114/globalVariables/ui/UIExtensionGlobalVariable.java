...
import lapr4.red.s1.ipc.n1141114.netGames.ui.*;
 ...
 */
public class UIExtensionGlobalVariable extends UIExtension {
    ...
    public UIExtensionGlobalVariable(Extension extension, UIController uiController) {
    ...
    public JComponent getSideBar() {
        if (sideBar == null) {
            sideBar = new GlobalVariableUI(uiController);
        }
        return sideBar;
    }
