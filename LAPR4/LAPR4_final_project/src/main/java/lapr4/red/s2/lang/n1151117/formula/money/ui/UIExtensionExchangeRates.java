 ...
 * @author Barros
 */
public class UIExtensionExchangeRates extends UIExtension {
    ...
    public UIExtensionExchangeRates(Extension extension, UIController uiController) {
    ...
    public JComponent getSideBar() {
        if (sideBar == null) {
            sideBar = new ExchangeRatesUI(uiController);
        }
        return sideBar;
