...
import lapr4.red.s2.lang.n1141114.temporaryVariables.compiler.*;
...
import lapr4.gray.s1.lang.n3456789.formula.compiler.Formula2BaseVisitor;
import lapr4.gray.s1.lang.n3456789.formula.compiler.Formula2Parser;
...
//                if (ctx.getChild(1).getChildCount() == 0) { // Conclude that operator is on the right
    ...
    public Expression visitLiteral(Formula2Parser.LiteralContext ctx) {
        ...
        if (t.getType() == Formula2Parser.NUMBER) {
            ...
            } else if (t.getType() == Formula2Parser.VAR) {
