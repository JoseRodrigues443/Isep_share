 ...
 * @author Tiago
 */
public class UIExtensionFileShare extends UIExtension{
    ...
    public UIExtensionFileShare(Extension extension, UIController uiController) {
    ...
    public JComponent getSideBar() {
        if (sideBar == null) {
            sideBar = new FileShareUI(uiController);
        }
        return sideBar;
    }
