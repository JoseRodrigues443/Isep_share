 ...
 * @author João Coelho
 */
public class UIextensionLogList extends UIExtension{
    
    private JComponent sideBar;
    
    public UIextensionLogList(Extension extension, UIController uiController) {
    ...
    public JComponent getSideBar() {
        if (sideBar == null) {
            sideBar = new LogListUI(uiController);
        }
        return sideBar;
