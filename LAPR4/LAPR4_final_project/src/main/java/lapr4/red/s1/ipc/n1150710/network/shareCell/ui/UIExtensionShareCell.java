 ...
 */
public class UIExtensionShareCell extends UIExtension {
    ...
    public UIExtensionShareCell(Extension extension, UIController uiController) {
    ...
    public JMenu getMenu() {
        if (menu == null) {
            menu = new ShareCellMenu(uiController);
        }
        return menu;
        //return null;
    }
    ...
    public JComponent getSideBar() {
        if (sideBar == null) {
            sharePanel = new SharePanel(uiController);
            sideBar = sharePanel;
        }
        return sideBar;
    }
