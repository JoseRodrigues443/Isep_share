 ...
 */
public class UIExtensionAutoSorting extends UIExtension {

    private AutoSortingMenu menu;

    public UIExtensionAutoSorting(Extension extension, UIController uiController) {
    ...
    public JMenu getMenu() {
        if (menu == null) {
            menu = new AutoSortingMenu(this.uiController);
        }
        return menu;
    }
