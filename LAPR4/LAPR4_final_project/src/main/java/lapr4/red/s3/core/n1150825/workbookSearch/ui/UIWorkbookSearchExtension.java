 ...
 * @author João Coelho
 */
public class UIWorkbookSearchExtension extends UIExtension {
    ...
    public UIWorkbookSearchExtension(Extension extension, UIController uiController) {
    ...
    public JComponent getSideBar() {
        if (sideBar == null) {
            sideBar = new WorkbookSearchUI(uiController);
        }
        return sideBar;
