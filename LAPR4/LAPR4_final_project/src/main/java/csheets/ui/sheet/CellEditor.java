...
import lapr4.red.s2.lang.n1150710.BeanShell.Integration.BeanShellIntegrationExtension;
...
public class CellEditor extends JTextField implements TableCellEditor, SelectionListener {
	...
	public boolean stopCellEditing() {
		String content = getText();
                /**
                 * @autor josé rodrigues 1150710
                 * 
                 * BeanShellIntegration Lang 7.1,7.2: enables the extension to be able
                 * to get the String inserted in the cell, an then compile
                 * all the beanShellScript inserted in memory
                 * 
                 */
                content = BeanShellIntegrationExtension.beanShellIntegration(content);
