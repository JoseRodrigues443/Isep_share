...
public class MenuBar extends JMenuBar {
    ...
    public MenuBar(CleanSheets app, ActionManager actionManager, UIController uiController) {
        ...
        fileMenu.addSeparator();
        fileMenu.add(actionManager.getAction("import xml"));
        fileMenu.add(actionManager.getAction("export xml"));
        fileMenu.addSeparator();
        fileMenu.add(actionManager.getAction("import country codes"));
        fileMenu.add(actionManager.getAction("import postal codes"));
        fileMenu.addSeparator();
