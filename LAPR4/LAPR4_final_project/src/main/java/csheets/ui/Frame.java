...
import lapr4.blue.s1.core.n1150433.addressEdition.domain.postalCode.ImportPostalCodesAction;
import lapr4.blue.s1.core.n1150595.emailAndPhoneEdition.domain.phoneNumbers.countryCode.ImportCountryCodesAction;
import lapr4.blue.s3.lang.n1140525.AdvancedWizard.ui.AdvancedWizardButton;
import lapr4.green.s1.lang.n1150993.exportXML.ui.ExportXMLAction;
import lapr4.red.s2.lang.n1150825.IntermediateWizard.ui.IntermediateWizardButton;
import lapr4.red.s2.lang.n1150466.importXML.ui.ImportXMLAction;
...
public class Frame extends JFrame implements SelectionListener {
    ...
    public Frame(CleanSheets app) {
        ...
        actionManager.registerAction("import xml", new ImportXMLAction(uiController));
        actionManager.registerAction("export xml", new ExportXMLAction(uiController));
        actionManager.registerAction("import country codes", new ImportCountryCodesAction(uiController));
        actionManager.registerAction("import postal codes", new ImportPostalCodesAction(uiController));
        ...
        // Creates the wizard launch button
        // 1150825
        AdvancedWizardButton wizardButton = new AdvancedWizardButton(uiController);
        ...
        // created to solve the problem with the cellEditor
        // 1150825
        JPanel cellArea = new JPanel(new FlowLayout());
        // they're put into the cellArea
        // 1150825
        cellArea.add(addressBox);
        cellArea.add(wizardButton);
        // the cellArea is put into the West BorderLayout Position
        // 1150825
        cellPanel.add(cellArea, BorderLayout.WEST);
