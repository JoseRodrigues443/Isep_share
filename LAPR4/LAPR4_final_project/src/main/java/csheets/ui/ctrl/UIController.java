...
public class UIController implements SpreadsheetAppListener {
    ...
    //saves the condition used in conditional formatting cell
    ...
    /**
     * Returns CleanSheets application.
     * @return CleanSheets application
     */
 ...
 * EVENT FIRING & LISTENING
    ...
    public int getActivateColumn() {
        return activeColumn;
    }

    public void setActivateColumn(int index) {
        if (this.activeColumn == index && !this.sortingOrder) {
            this.sortingOrder = true;
        } else if (this.activeColumn == index && this.sortingOrder) {
            this.sortingOrder = false;
        } else if(this.activeColumn != index){
