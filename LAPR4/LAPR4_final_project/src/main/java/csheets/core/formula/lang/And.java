...
public class And implements Function {
	...
	public boolean isVarArg() {
        ...
        public String getDescription() {
            return "A function that returns true if and only if all of its arguments are true.";
        }
    
        @Override
        public String getSyntax() {
            return "=AND(rowColumnNumber binaryOperator rowColumnNumber, rowColumnNumber binaryOperator rowColumnNumber)";
        }
