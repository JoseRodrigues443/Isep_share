...
public class ExtensionManager {
	...
	public Extension getExtension(String name) {
		return extensionMap.get(name);
         ...
         /**
         * Returns all versions of an extension.
         * @param name, the name of the extension
         * @return the versions with the given extension's name
         */
        public ArrayList<Extension> getExtensionVersions(String name) {
            ArrayList<Extension> e = new ArrayList<>();
	...
	public Extension load(Class extensionClass) {
        ...
        /**
         * Returns index in the array of a certain extension.
         * @param name, the name of the extension
         * @param version, the version of the extension
         * @return the index of the extension with the given name and version
         */
        public int getExtensionByNameAndVersion(String name, String version) {
            int i=0;
            
            for (Map.Entry<String, Extension> entry : extensionMap.entrySet()) {
               if (entry.getKey().equals(name) && entry.getValue().getVersion().equals(version)) {
                   return i;
               }
               i++;
            }
        ...
        public void unload(String name, String version) {
             ...
             for(Iterator<Map.Entry<String, Extension>> it = extensionMap.entrySet().iterator(); it.hasNext(); ) {
                 Map.Entry<String, Extension> entry = it.next();
