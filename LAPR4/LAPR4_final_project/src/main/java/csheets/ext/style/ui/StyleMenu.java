...
import lapr4.green.s1.lang.n1141431.conditional.formatting.ui.ConditionalFormattingCellJMenu;
import lapr4.red.s2.lang.n1150834.conditionalFormatting.ui.ConditionalFormattingRangeAction;
...
public class StyleMenu extends JMenu {
    ...
    public StyleMenu(UIController uiController) {
        ...
        //add conditional format of a cell option
        add(new ConditionalFormattingCellJMenu(uiController));
        //add conditional format of a range option
